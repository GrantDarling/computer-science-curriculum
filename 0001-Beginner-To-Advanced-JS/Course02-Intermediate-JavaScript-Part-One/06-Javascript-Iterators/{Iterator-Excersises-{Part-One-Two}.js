...
/* 
Write a function called vowelCount that accepts a string and returns an object with each key being
the vowel and the value being the number of times the vowel occurs in the string (the order of keys 
in the object does not matter).
*/

var vowels = ['a', 'e', 'i', 'o', 'e', 'u'];

var removeVowels = function (string) {
  var array = string.toLowerCase().split('')

  return array.filter(function (element) {
    if (vowels.some(x => x === element) !== true) return element
  })
