...
;; Natural -> Image
;; Takes in a number and produces the equivalent row of cookies
(check-expect (row 0 COOKIES) BLANK)
(check-expect (row 1 COOKIES) (beside COOKIES BLANK))
(check-expect (row 3 COOKIES) (beside COOKIES COOKIES COOKIES BLANK))
...
;; ListOfBlob -> ListOfBlob
;; moves all "solid" blobs to bottom of list
(define (sink lob)
...
;; sink the blob, if solid, pass at most one blob
